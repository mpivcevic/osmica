...
> **These three are Stage E's, as of 24 Aug 2026.** They were found while testing
> Stage C and carried through Stage D untouched — deliberately, since none of
> them is an exposure and Stage D was. They are now the app's robustness
> backlog, alongside Stage E's security items (TOTP for the owner, single-use
> expiring invite tokens, dropping `phone`). Inheriting them on purpose rather
> than by forgetting: see `osmica_security_plan.md` § Stage E.
