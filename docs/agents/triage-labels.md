...
This repo uses a local-markdown tracker, so these are **`Status:` line values** inside
`.scratch/<feature-slug>/issues/NN-<slug>.md`, not GitHub labels. Nothing needs creating
up front — write the string.
